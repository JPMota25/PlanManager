...
namespace PlanManager.Infrastructure.Migrations
{
    ...
    [Migration("20250718190700_AddTablePlanPermissionRelation")]
    partial class AddTablePlanPermissionRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PlanManager.Domain.Entities.Plan.PlanPermissionRelation", b =>
                {
                    ...
                    b.Property<string>("PlanPermissionId")
                        .HasColumnType("nvarchar(11)");
            ...
            modelBuilder.Entity("PlanManager.Domain.Entities.Plan.PlanPermissionRelation", b =>
                {
                    ...
                    b.HasOne("PlanManager.Domain.Entities.Plan.Plan", null)
                        .WithMany("Permissions")
                        .HasForeignKey("PlanId")
                        .HasConstraintName("FK_PlanPermissionRelation_Plan_PlanId1");

                    b.HasOne("PlanManager.Domain.Entities.Plan.PlanPermission", null)
                        .WithMany("Plans")
                        .HasForeignKey("PlanPermissionId")
                        .HasConstraintName("FK_PlanPermissionRelation_PlanPermission_PlanPermissionId1");
